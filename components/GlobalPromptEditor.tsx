        ...
        {isExpanded && (
          <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1">
              <label className="text-xs font-medium text-green-400">{t('positivePromptsPrefix')}</label>
              <textarea
            ...
            <div className="space-y-1">
              <label className="text-xs font-medium text-red-400">{t('negativePrompt')}</label>
              <textarea
