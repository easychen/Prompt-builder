...
- **Structured Fields**: Organize character details into 6 categories:
  - 🧍 **Basic Appearance**: Age, Gender, Race, Hair, Eyes, Skin
  - 👗 **Outfit Top**: Shirts, Jackets, Coats
  - 👖 **Outfit Bottom**: Pants, Skirts, Legwear, Shoes
  - 💍 **Accessories**: Necklaces, Headwear, Glasses, Earrings
  - 🧍‍♀️ **Body & Pose**: Body type, Pose, Expression
  - 🎨 **Environment & Style**: Background, Camera, Lighting
...
5. Click **"Start Fill"** to auto-generate all character fields
...
2. Click the **"Translate"** button on character header
3. AI will:
...
1. Click the **"Copy"** button on character header
2. Choose from:
...
1. Add tags in the **Notes & Tags** section using `#tag` format
